                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9 row" style="float: right;">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="checkbox" value="Kabid Pendataan Penetapan Dan Pelayanan" name="penerima_disposisi_2[]"> Kabid Pendataan Penetapan Dan Pelayanan<br>
                                            <input type="checkbox" value="Kabid Penagihan Dan Keberatan" name="penerima_disposisi_2[]"> Kabid Penagihan Dan Keberatan <br>
                                            <input type="checkbox" value="Kabid Perbendaharaan" name="penerima_disposisi_2[]"> Kabid Perbendaharaan <br>
                                            <input type="checkbox" value="Kabid Pengelolaan Aset" name="penerima_disposisi_2[]"> Kabid Pengelolaan Aset <br>
                                            <input class="mb-4" type="checkbox" value="Kabid Akuntansi" name="penerima_disposisi_2[]"> Kabid Akuntansi <br>  
                                            <input type="checkbox" value="Semua Kasubag" name="penerima_disposisi_2[]"> Semua Kasubag <br>
                                            <input type="checkbox" value="Kasubag Bina Program" name="penerima_disposisi_2[]"> Kasubag Bina Program <br>
                                            <input type="checkbox" value="Kasubag Umum Dan Kepegawaian" name="penerima_disposisi_2[]"> Kasubag Umum Dan Kepegawaian <br>
