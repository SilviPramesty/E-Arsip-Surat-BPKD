    ...
    <table align="center" border="0" cellpadding="1" style="width: 700px;" class="table-bordered">
        <tbody>
            ...
            <tr>
                <td colspan="3">
                    <div align="center">
                        <span style="font-family: Verdana; font-size: x-small;"><b>PERHATIAN: Dilarang memisahkan sehelai surat pun yang digabung
                                dalam berkas ini !</b></span>
                    ...
                    <table border="0" cellpadding="1" style="width: 400px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span style="font-size: x-small;">:</span></td>
                                <td><span
                                        style="font-size: x-small;">{{ Carbon\Carbon::parse($item->letter->date_received)->translatedFormat('l, d F Y') }}</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tfoot>
                            <tr>
                                <div class="row" style="float: left;">
                                    <div class="col">
                                        <td width="350">
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Sekretaris"
                                                    name="penerima_disposisi_2[]"
                                                    {{ in_array('Sekretaris', $disposisi) ? 'checked' : '' }}>&nbsp;Sekretaris</span><br>

                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Kabid Anggaran"
                                                    name="penerima_disposisi_2[]"
                                                    {{ in_array('Kabid Anggaran', $disposisi) ? 'checked' : '' }}>&nbsp;Kabid Anggaran</span><br>

                                            <span style="font-size: x-small;">&emsp;<input type="checkbox"
                                                    value="Kabid Pendataan Penetapan Dan Pelayanan" name="penerima_disposisi_2[]"
                                            ...
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Kabid Penagihan Dan Keberatan"
                                                    name="penerima_disposisi_2[]"
                                                    {{ in_array('Kabid Penagihan Dan Keberatan', $disposisi) ? 'checked' : '' }}>&nbsp;Kabid
                                                Penagihan Dan Keberatan</span><br>

                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Kabid Perbendaharaan"
                                                    name="penerima_disposisi_2[]"
                                                    {{ in_array('Kabid Perbendaharaan', $disposisi) ? 'checked' : '' }}>&nbsp;Kabid
                                                Perbendaharaan</span><br>

                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Kabid Pengelolaan Aset"
                                                    name="penerima_disposisi_2[]"
                                                    {{ in_array('Kabid Pengelolaan Aset', $disposisi) ? 'checked' : '' }}>&nbsp;Kabid Pengelolaan
                                                Aset</span><br>

                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="-"
                                                    name="penerima_disposisi_2[]"
                                ...
                                <div class="row" style="float: left;">
                                    <div class="col">
                                        <td width="100">
                                            ...
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Teliti & Pendapat"
                                                    name="petunjuk[]" {{ in_array('Teliti & Pendapat', $petunjuk) ? 'checked' : '' }}>&nbsp;Teliti &
                                                Pendapat</span><br>
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Untuk Diketahui"
                                                    name="petunjuk[]" {{ in_array('Untuk Diketahui', $petunjuk) ? 'checked' : '' }}>&nbsp;Untuk
                                                Diketahui</span><br>
                                            ...
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Sesuai Catatan"
                                                    name="petunjuk[]" {{ in_array('Sesuai Catatan', $petunjuk) ? 'checked' : '' }}>&nbsp;Sesuai
                                                catatan</span><br>
                                            <span style="font-size: x-small;">&emsp;<input type="checkbox" value="Untuk Perhatian"
                                                    name="petunjuk[]" {{ in_array('Untuk Perhatian', $petunjuk) ? 'checked' : '' }}>&nbsp;Untuk
                                                Perhatian</span><br>
                                    ...
                                    <div class="col">
                                        <td width="100" valign="top">
                                            ...
                                            <span style="font-size: x-small;"><input type="checkbox" value="Bicarakan Dengan saya"
                                                    name="petunjuk[]"
                                            ...
                                            <span style="font-size: x-small;"><input type="checkbox" value="Harap dihadiri/diwakili"
                                                    name="petunjuk[]"
